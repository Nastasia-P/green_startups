...
If you only want to (re)classify with the committed lexicon, you can skip steps
1-4 and jump to steps 5-6, because `strong_terms_active.csv` and
`strong_term_phrases.csv` are committed.
...
# Redundancy reduction: drop longer phrases that contain a shorter kept phrase
